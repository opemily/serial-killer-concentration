...
$(function () {
  ...
  startGame = function () {
    ...
    for (var i = 0; i < serialKillers.length; i++) {
      $('<div></div>').addClass('square ' + serialKillers[i].class + ' covered').css('background',serialKillers[i].img).on('click', firstClick).appendTo('#board');
    }
